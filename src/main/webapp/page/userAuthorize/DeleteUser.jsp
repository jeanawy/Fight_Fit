                ...
                <div id="hide">
                    ...
                    <div class="row mt-2">
                        ...
                        <div  id="ko2" class="col-3 mt-3">
                            <button type="button" class="btn btn-primary" data-toggle="modal" id="modalcontro" onClick="checkdata()" >Delete</button>
                        </div>
                        <div class="col-3 mt-3">
                        </div>
                    </div> 
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    <div class="mx-auto">
                                        <h4 class="modal-title text-white" id="exampleModalLabel">Delete User To Group</h4>
                                    </div>
                                </div>
                                <div class="modal-body mt-2 mb-2">
                                    <h5> Confirm To Delete User</h5>
                                </div>
                    ...
                    <div class="modal fade" id="modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    <div class="mx-auto">
                                        <h4 class="modal-title text-white" id="exampleModalLabel">Delete
                                            User To Group</h4>
                                    </div>
                                </div>
                                <div class="modal-body mt-2 mb-2">
